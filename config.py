...
# ── 常用模型规格 ──────────────────────────────────
PRESETS = {
    "4.5M":  dict(vocab_size=4726,  max_seq_len=128, d_model=192,  n_layers=6,  n_heads=6,  d_ff=768,   dropout=0.2),
    ...
    # ── BPE 对话模型 ─────────────────────────────
    "100M":  dict(vocab_size=16000, max_seq_len=512, d_model=768,  n_layers=12, n_heads=12, d_ff=3072,  dropout=0.2),
    "200M":  dict(vocab_size=16000, max_seq_len=512, d_model=1024, n_layers=16, n_heads=16, d_ff=4096,  dropout=0.2),
    "400M":  dict(vocab_size=16000, max_seq_len=512, d_model=1280, n_layers=20, n_heads=16, d_ff=5120,  dropout=0.2),
    "512M":  dict(vocab_size=16000, max_seq_len=512, d_model=1280, n_layers=24, n_heads=16, d_ff=5120,  dropout=0.2),
}
...
def get_config(vocab_size: int = 16000, preset: str = None,
    ...
    params = dict(vocab_size=vocab_size, max_seq_len=512, d_model=768,
                  n_layers=12, n_heads=12, d_ff=3072, dropout=0.2)
